...
async function addPriceDataToFlight(flights) {
    for(var i = 0; i < flights.length; i++) {
        ...
        let flight_origin = get(stationCode).substr(1); // origin in icao format
        ...
        const baseURL = `https://flight-data-api.herokuapp.com/price?origin=${flight_origin}&destination=${destination}&depart_date=${depart_date}`;
